...
namespace TuneAndCraft.v5.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                Library lib = new Library { LibraryID = UserManager.Users.Count()};
                SourceContext temp = new SourceContext();
                temp.Libraries.Add(lib);
                temp.SaveChanges();

                var user = new ApplicationUser { UserName = model.Email, Email = model.Email , LibraryID = lib.LibraryID};
